...
/// The platform view type registered by `AmapMapNativePlugin` on the Android side.
const String _amapMapViewType = 'amap_kit_map/map_android';
...
class AmapMapsFlutterAndroid extends AmapMapsFlutterPlatform {
  AmapMapsFlutterAndroid({
    @visibleForTesting MapsApi Function(int mapId)? apiProvider,
  }) : _apiProvider = apiProvider ?? _productionApiProvider;

  /// Registers the Android implementation of AmapMapPlatform.
  static void registerWith() {
    AmapMapsFlutterPlatform.instance = AmapMapsFlutterAndroid();
  }
